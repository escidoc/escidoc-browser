        ...
        tblPagedResults.addListener(new Property.ValueChangeListener() {
            ...
            private Component buildResourceView(final Object[] variablesForTheTab) {
                if (variablesForTheTab[0].equals(ResourceType.CONTAINER.getLabel())) {
                    try {
                        new ContainerController(repositories, router, find(variablesForTheTab, ResourceType.CONTAINER));
                    }
                    catch (final EscidocClientException e) {
                        showerror();
                    }
                    ...
                    try {
                        new ItemController(repositories, router, find(variablesForTheTab, ResourceType.ITEM));
