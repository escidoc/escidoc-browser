...
public class ContextAddInfo {
	...
	public Panel addPanels(){
        ...
        Label cnt = new Label("<a href='/ESCD/#Unit/FIZ'>FIZ</a><br />"+
        ...
        Label lblAdmDescriptor = new Label("<a href='/ESCD/#Unit/FIZ'>PubMan Descriptor</a><br />"+
        						"<a href='/ESCD/#Unit/JUG'>Java User Group</a>",
                Label.CONTENT_RAW);
        ...
        Label lblrelations = new Label("isRelatedTo <a href='/ESCD/#Context/123'>Other Context</a><br />",
                Label.CONTENT_RAW);
        ...
        Label lblresources= new Label("<a href='/ESCD/#Resources/id'>Members Filtered</a><br />",
                Label.CONTENT_RAW);
