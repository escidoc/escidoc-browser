...
public class ContainerView extends VerticalLayout {
	...
	public ContainerView(final MainSite mainSite, final ResourceProxy resourceProxy) throws EscidocClientException {
		...
		//this is an assumption of the height that should be left for the accordion or elements of the DirectMember in the same level
        //I remove 420px that are taken by elements on the de.escidoc.esdc.page and 40px for the accordion elements?
