...
public class Router {
    ...
    public Controller buildController(final ResourceModel clickedResource) throws EscidocClientException {
            ...
            if (controllerClassName == null) {
                ...
                switch (clickedResource.getType()) {
                    case CONTAINER:
                        ...
                        controllerClassName = browserProperties.getProperty(ControllerIdList.CONTAINER_CONTROLLER_ID);
                        break;
                    case ITEM:
                        LOG.info("Fallback to Item Controller.");
                        controllerClassName = browserProperties.getProperty(ControllerIdList.ITEM_CONTROLLER_ID);
                        break;
                }
                if (controllerClassName == null) {
