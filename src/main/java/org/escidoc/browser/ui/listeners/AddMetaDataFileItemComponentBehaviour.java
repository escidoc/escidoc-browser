...
public class AddMetaDataFileItemComponentBehaviour implements ClickListener {
    private static final Logger LOG = LoggerFactory.getLogger(AddMetaDataFileItemComponentBehaviour.class);
    ...
    private final ItemComponentMetadataVH itemComponentMDView;

    public AddMetaDataFileItemComponentBehaviour(final Window mainWindow, final Component component,
        ItemController controller, ItemProxyImpl itemProxy, ItemComponentMetadataVH itemComponentMDView) {
        Preconditions.checkNotNull(itemProxy, "itemProxy is null.");
        Preconditions.checkNotNull(controller, "ItemController is null.");
        this.component = component;
        this.itemComponentMDView = itemComponentMDView;
