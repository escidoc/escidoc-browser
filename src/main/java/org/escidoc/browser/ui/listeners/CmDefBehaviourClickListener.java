...
public class CmDefBehaviourClickListener implements ClickListener {
    ...
    public CmDefBehaviourClickListener(final ContainerProxy resourceProxy,
        final Window mainWindow,
        final EscidocServiceLocation escidocServiceLocation) {
        this.mainWindow = mainWindow;
    }

    public CmDefBehaviourClickListener(final ItemProxy resourceProxy,
        final Window mainWindow,
        final EscidocServiceLocation escidocServiceLocation) {
        this.mainWindow = mainWindow;
    }
    ...
    public void buttonClick(final ClickEvent event) {
        ...
        final Label msgWindow =
            new Label("Not implemented yet", Label.CONTENT_RAW);
