...
public class InstituteSelectionLayoutListener implements LayoutClickListener {
    ...
    public InstituteSelectionLayoutListener(final ILabsInstrumentAction labsInstrumentAction) {
    ...
    public void layoutClick(LayoutClickEvent event) {
        ...
        try {
            ...
            if (dataComponent instanceof Label) {
                BeanItemContainer<OrgUnitBean> itemContainer = new BeanItemContainer<OrgUnitBean>(OrgUnitBean.class);
