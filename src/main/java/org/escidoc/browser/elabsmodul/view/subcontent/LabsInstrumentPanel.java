...
public class LabsInstrumentPanel extends Panel implements ILabsPanel, ILabsAction {
    ...
    public LabsInstrumentPanel(Window mainWindow, InstrumentBean sourceBean, ResourceProxy resourceProxy,
        ItemRepository itemRepositories) {
    ...
    public void saveAction() {
        ...
        try {
            ...
            metadataRecord.setContent(InstrumentController.createDOMElementByBeanModel(instrumentBean));
