...
final public class ELabsViewContants {
    ...
    public static final String[] INSTRUMENT_PROPERTIES =
        { P_INSTRUMENT_TITLE, P_INSTRUMENT_DESC, P_INSTRUMENT_CREATEON, P_INSTRUMENT_CREATEDBY,
            P_INSTRUMENT_MODIFIEDON, P_INSTRUMENT_CONFIGURATION, P_INSTRUMENT_CALIBRATION, P_INSTRUMENT_ESYNCDAEMON,
            P_INSTRUMENT_FOLDER, P_INSTRUMENT_FILEFORMAT, P_INSTRUMENT_CONTEXT, P_INSTRUMENT_CONTENTMODEL,
            P_INSTRUMENT_DEVICESUPERVISOR, P_INSTRUMENT_INSTITUTE };
    ...
    public static final String[] INVESTIGATION_PROPERTIES =
        { P_INVESTIGATION_TITLE, P_INVESTIGATION_DESC, P_INVESTIGATION_DEPOSIT_SERVICE, P_INVESTIGATION_INVESTIGATOR,
            P_INVESTIGATION_DURATION, P_INVESTIGATION_RIG };
